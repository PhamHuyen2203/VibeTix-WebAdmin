...
export const approveOrganizer = onCall({ region: 'asia-southeast1' }, async (request) => {
    ...
    // 6. Write audit log
    await writeAuditLog(admin.uid, admin.displayName, 'organizer.approve', 'organizer', organizerId, { previousStatus: currentStatus });
